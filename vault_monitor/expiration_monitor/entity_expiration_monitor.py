...
class EntityExpirationMonitor(ExpirationMonitor):
    ...
    def __init__(
        self, mount_point: str, monitored_path: str, name: str, vault_client: hvac.Client, service: str, prometheus_labels: Optional[Dict[str, str]] = None, metadata_fieldnames: Optional[Dict[str, str]] = None
    ) -> None:
